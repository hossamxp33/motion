! function (a, b, c, d) {
    ...
    var e = "prettyCheckable",
        ...
        h = function (c) {
            ...
            }), c.find("a:first, label").on("click", function (c) {
                c.preventDefault();
    ...
    i.prototype = {
        init: function (b) {
            ...
            var hovertitle = '';
            if (c.data('title') != undefined) {
                hovertitle = c.data('title');
            }

            "labelright" === j ? (o.push('<a href="#" class="' + p + " " + m + '" title="' + hovertitle + '"><span class="prettyDesign"></span></a>'), o.push('<label for="' + c.attr("id") + '" title="' + hovertitle + '">' + f + "</label>")) : (o.push('<label for="' + c.attr("id") + '" title="' + hovertitle + '">' + f + "</label>"), o.push('<a href="#" class="' + p + " " + m + '" title="' + hovertitle + '"><span class="prettyDesign"></span></a>')), c.parent().append(o.join("\n")), h(c.parent())
        },
        check: function () {
